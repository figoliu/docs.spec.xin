...
<p align="center">
    <strong>让组织专注于产品场景，而非编写无差异化代码。规范驱动开发(Spec-Driven Development)为您赋能. </strong>
</p>

> **💡 [GitHub Speckit](https://github.com/github/spec-kit) 目前只支持英文，[Spec.xin](https://github.com/figoliu/spec.xin) 提供验证后的的中文优化版，大部分工作基于 [Specify CN](https://github.com/Linfee/spec-kit-cn) 实现**
...
详细的分步说明, 请参阅我们的[SDD宣言](./SDD/SDD宣言.md).
...
- **[完整的规范驱动开发方法论](./SDD/SDD宣言.md)** - 深入了解完整流程
- **[详细演练](#-详细流程)** - 分步实施指南
...
- Figo Liu ([@figoliu](https://github.com/figoliu))

## 💬 支持

如需支持, 请打开[GitHub issue](https://github.com/figoliu/spec.xin/issues/new). 我们欢迎错误报告、功能请求和关于使用规范驱动开发的问题.
